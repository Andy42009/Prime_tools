//编译程序:gcc primetools【0.8.1】.c -o primetools【0.8.1】.exe -lwinmm
...
int title_print_1()
{
	printf("**********************************************************************************************************PRIME TOOLS V 0.7.3【Page1】*****************************************************************************************************\n");
...
int title_print_2()
{
	printf("********************************************************************************************PRIME TOOLS V 0.8.1【Page2】**************************************************************************\n");
	printf("*************************************************************************1.check_primes 2.汉诺塔游戏 3.赞助作者 4.检查更新 5.last page************************************************************\n");
	printf("**************************************************************************************************************************************************************************************************\n");
	printf("Copyright Prime Tools Andy.AB   !!!\n");
}
...
int Changelog()
{
	...
	printf("\n");
	printf("版本0.7.3【加入更新】【重大更新】:\n");
	printf("时间:2024.4.5\n");	
	printf("内容:primetools加入了加入了检查更新，我会在GitHub上发布定期最新版本，可以下载任意版本!!!:)\n");
	printf("\n");
	printf("版本0.8.1【修改更新】:\n");
	printf("时间:2024.4.7\n");	
	printf("内容:primetools修改了7处已知错误!!!!!!!!:)\n");	
...
int main()
{
	...
	SetConsoleTitle("primes number tools 【Version：0.7.3】-----正式版本欢迎体验!");
	...
	if(choices == 7)
	{
		...
		if(choices == 4) 
		{
			...
			system("start https://github.com/Andy42009/Prime_tools.git");
